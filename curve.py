...
class Catmull:
    ...
    def at(self, x, t):
        ...
        v2 = self.points[x]
        v3 = self.points[x + 1] if x + \
            1 < self.order else array_calc('1', v2, array_calc('-1', v2, v1))
        v4 = self.points[x + 2] if x + \
            2 < self.order else array_calc('1', v3, array_calc('-1', v3, v2))
